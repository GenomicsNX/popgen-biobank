...
f = paste0(local_data_dir, "/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_YRILDpruned.fam")
...
for(pop in Spops){
	...
	path = f = paste0(local_data_dir, "/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/")
...
# grep GBR 1000G_Ind_Pop.txt | cut -f 1 > $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/GBRids.txt
# grep ITU 1000G_Ind_Pop.txt | cut -f 1 > $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ITUids.txt
# grep CHS 1000G_Ind_Pop.txt | cut -f 1 > $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/CHSids.txt
# grep YRI 1000G_Ind_Pop.txt | cut -f 1 > $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/YRIids.txt
...
# ## Unrelated ID lists
# ############
# cd $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge
...
####################################
## EUR
GENO=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg
OUT=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_EUR
INDS2KEEP=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/EUR_ancestry_ind_list.txt
SNPS2KEEP=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/EUR.prune.in

plink --bfile $GENO --keep $INDS2KEEP --extract $SNPS2KEEP --make-bed --out $OUT

## SAS
GENO=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg
OUT=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_SAS
INDS2KEEP=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/SAS_ancestry_ind_list.txt
SNPS2KEEP=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/SAS.prune.in

plink --bfile $GENO --keep $INDS2KEEP --extract $SNPS2KEEP --make-bed --out $OUT

## EAS
GENO=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg
OUT=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_EAS
INDS2KEEP=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/EAS_ancestry_ind_list.txt
SNPS2KEEP=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/EAS.prune.in

plink --bfile $GENO --keep $INDS2KEEP --extract $SNPS2KEEP --make-bed --out $OUT

## AFR
GENO=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg
OUT=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_AFR
INDS2KEEP=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/AFR_ancestry_ind_list.txt
SNPS2KEEP=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/AFR.prune.in
...
## 1. AFR
###############
genotypename: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_AFR.bed
snpname: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_AFR.bim
indivname: $local_data_dir/data/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_AFR.fam
...
genotypename: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_EAS.bed
snpname: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_EAS.bim
indivname: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_EAS.fam
...
genotypename: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_YRILDpruned_SAS.bed
snpname: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_YRILDpruned_SAS.bim
indivname: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_YRILDpruned_SAS.fam
...
genotypename: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_YRILDpruned_EUR.bed
snpname: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_YRILDpruned_EUR.bim
indivname: $local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_YRILDpruned_EUR.fam
...
## 1. AFR
###############
f = paste0(local_data_dir,"/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_AFR.fam")
fam = read.table(f, header = FALSE, sep = " ", as.is = TRUE)
...
###############
f = paste0(local_data_dir,"/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_EAS.fam")
fam = read.table(f, header = FALSE, sep = " ", as.is = TRUE)
ids = paste0(fam[,1], ":", fam[,2])
out = data.frame(ids = ids, sex = "U", pop = fam[,2])
for(i in 1:3){ out[,i] = as.character(out[,i])  }
...
## 3. SAS
###############
f = paste0( local_data_dir, "/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_SAS.fam")
fam = read.table(f, header = FALSE, sep = " ", as.is = TRUE)
ids = paste0(fam[,1], ":", fam[,2])
out = data.frame(ids = ids, sex = "U", pop = fam[,2])
for(i in 1:3){ out[,i] = as.character(out[,i])  }
...
## 4. EUR
###############
f = paste0(local_data_dir,"/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_EUR.fam")
fam = read.table(f, header = FALSE, sep = " ", as.is = TRUE)
ids = paste0(fam[,1], ":", fam[,2])
out = data.frame(ids = ids, sex = "U", pop = fam[,2])
for(i in 1:3){ out[,i] = as.character(out[,i])  }
##
f = paste0(local_data_dir,"/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/EUR.rel.id")
