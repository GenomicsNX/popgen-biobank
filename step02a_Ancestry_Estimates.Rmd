---
title: "Non-European British Ancestry"
output: pdf_notebook
---
...
dim(out)
f = paste0(results_dir, "admixture/continental_ancestry/UKB_IDs_80Perc_EUR_Anc.txt" )
...
out = data.frame(id = UKBBdata[w, 1] , fid = UKBBdata[w, 1])
dim(out)
f = paste0(results_dir, "admixture/continental_ancestry/UKB_IDs_80Perc_EAS_Anc.txt" )
write.table(out, file = f, row.names = FALSE, col.names = FALSE, sep = " ", quote = FALSE)
...
out = data.frame(id = UKBBdata[w, 1] , fid = UKBBdata[w, 1])
dim(out)
f = paste0(results_dir, "admixture/continental_ancestry/UKB_IDs_80Perc_SAS_Anc.txt" )
write.table(out, file = f, row.names = FALSE, col.names = FALSE, sep = " ", quote = FALSE)
...
out = data.frame(id = UKBBdata[w, 1] , fid = UKBBdata[w, 1])
dim(out)
f = paste0(results_dir, "admixture/continental_ancestry/UKB_IDs_80Perc_AFR_Anc.txt" )
write.table(out, file = f, row.names = FALSE, col.names = FALSE, sep = " ", quote = FALSE)
...
##
# pdf( paste0(results_dir, "admixture/continental_ancestry/UKBB_ContinentalAncestry_Estimates.pdf" ), width = 15, height = 8)
# postscript( paste0(results_dir, "admixture/continental_ancestry/UKBB_ContinentalAncestry_Estimates.eps" ), width = 15, height = 8)
#png( paste0(results_dir, "admixture/continental_ancestry/UKBB_ContinentalAncestry_Estimates.png" ), width = 15, height = 8, units = "in", res = 150)
...
# pdf( paste0(results_dir, "admixture/continental_ancestry/UKBB_Cont_Ancestries.pdf" ), width = 10, height = 3)
###
...
# pdf( paste0(results_dir, "admixture/continental_ancestry/UKBB_PCA_wAncestry_v2.pdf" ), width = 10, height = 10)
...
for(percent in s){
  ...
  ###
  f = paste0(results_dir, "admixture/continental_ancestry/UKB_Ind_IDs_with_",percent*100,"Perc_YRI_Anc.txt" )
