#################################################
## This is a short script to identify a list
##  of "related" and "unrelated" individuals
##  from the output of smartrel log file
##  By: David A Hughes
##  date: April 6th 2020
#################################################
## the data input for this script is the relatedness
## table of the smartrel log file. This is a part
## of the EIGENSOFT package

## the required data are in column 2 and 3

## Read in the file name from the command line
args = commandArgs(trailingOnly=TRUE)
args = "1KG_AFR_IDs_and_UKBB_80Percent_AFR_Kinship.smartrel.rel"
