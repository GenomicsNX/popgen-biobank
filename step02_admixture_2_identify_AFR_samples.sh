##################################################
## Scripts to Run Admixture
## on UKBB NON-Europeans Brits
## ------
## David Hughes
## Oct 31th
##################################################
...
###########################
## Read in fam file
f = paste0(local_data_dir, "/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg.fam")
...
## which 1000 Genomes samples do I want to remove from the merged data set for admixtrue analysis?
...
OUT=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_popreduced
IN2remove=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/KGenomes_samples_2_remove.txt
...
## in R
####################
f = paste0(local_data_dir, "/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_popreduced.fam" )
fam = read.table(f, header = FALSE, sep = " ", as.is = TRUE) 
...
pop[is.na(pop)] = "-"
pop = data.frame(pop)
f = paste0( local_data_dir, "/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_popreduced.pop" )
...
GENO=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_popreduced
OUT=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/YRI_LD
...
##########################
OUT=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_popreduced_YRILDpruned
...
## 1KG samples
#######################
GENO=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/ukb_1kg_popreduced_YRILDpruned
OUT=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/testsamples
IN2KEEP=$local_data_dir/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/test_sampleids.txt
...
scp dh16508@bluecrystalp3.bris.ac.uk:/newhome/dh16508/scratch/AFR_neutrophil/data/genotypes/nonwhiteEUR/directly_genotyped/ukb_nonwhite_1kg_merge/sample_ancestry_K4.txt ./
